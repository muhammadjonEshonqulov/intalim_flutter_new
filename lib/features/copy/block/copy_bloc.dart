...
class CopyBloc extends Bloc<CopyEvent, NetworkResult> {
  final CopyRepository loginRepository;

  CopyBloc(this.loginRepository) : super(const Loading()) {
    on<CopyEventData>((event, emit) async {
      emit(const Loading());
